...
<!-- Admin Update Form Popup -->
<div class="w3-container update-form">
  <div id="updt-admin-form" class="w3-modal">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      <div class="multicolor-border"></div>
      <div class="w3-center"><br>
        <span onclick="document.getElementById('updt-admin-form').style.display='none'" class="w3-button w3-xlarge w3-hover-red w3-display-topright" title="Close Modal">&times;</span>
      </div>
      <form class="clearfix popupForm" method="post" action="http://localhost/portal/submission/update-admin.php?id=<?php echo $userId; ?>">
        <p>Please provide the following details for teacher.</p>
        <div class="form-row">
          <div class="form-group col-6">
            <input value="<?php echo $row['admin_id'] ?>" type="number" class="form-control" placeholder="ID" pattern="[0-9]*" name="id" disabled>
          </div>
          <div class="form-group col-6">
